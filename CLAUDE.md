...
- 按鍵 remap UI 已做（2026-07-13）：mapping 分 profile 存（standard=Xbox/PS4/PS5/PC、joycon=單 Joy-Con），設定視窗可逐動作「重新綁定」擷取按鍵；控制器靠 GCController extendedGamepad 通用支援，標籤用即時 localizedName
- backlog 見 PLAN.md（Launch at Login、GitHub repo、AppIcon/dmg）
